...
/*
 * T_NGX: tengine reserves more NGX_COMPAT spare slots (25) than nginx core (7)
 * for ngx_stream_upstream_rr_peer_s.  This guard keeps the tengine value
 * isolated so a future nginx core sync cannot silently overwrite it.
 */
#define T_NGX_STREAM_UPSTREAM_RR_PEER_SPARE  1
